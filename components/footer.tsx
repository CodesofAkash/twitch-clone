    ...
    <footer className="border-t bg-gradient-to-b from-background to-muted/20 mt-20">
      <div className="max-w-screen-2xl mx-auto px-8">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-2">
                The modern platform for live streaming and community building.
              </p>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <a
                href="https://www.instagram.com/codesofakash/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center w-9 h-9 rounded-lg bg-muted hover:bg-muted/80 transition-colors"
        ...
        <div className="py-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          <p>
            © {new Date().getFullYear()} OpenStream. Built with Next.js, LiveKit, and Clerk.
          </p>
